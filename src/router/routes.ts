...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/usuarios/crear', component: () => import('components/usuarios/VFormularioUsuarios.vue') },
      { path: '/preinscripciones', component: () => import('components/preinscripciones/VPreinscripciones.vue') },
    ],
